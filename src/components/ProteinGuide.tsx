      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-slate-800 mb-4">
            THE PROTEIN <span className="text-blue-600">GUIDE</span>
          </h1>
        ...
        <section className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-2xl font-bold text-slate-800">1. プロテインの3大種類</h2>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            {/* Whey */}
            <div className="bg-white border border-slate-200 rounded-2xl p-6 relative overflow-hidden group hover:border-blue-600 transition-colors shadow-sm">
              <div className="absolute top-0 right-0 w-24 h-24 bg-blue-600/10 rounded-full blur-2xl -mr-10 -mt-10"></div>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-slate-800">ホエイ<br/><span className="text-sm font-normal text-slate-500">Whey Protein</span></h3>
                <Zap className="w-8 h-8 text-blue-600" />
              </div>
              <div className="space-y-3 text-sm text-slate-600">
                <div className="flex items-center"><span className="w-20 text-slate-400 font-bold text-xs">原料</span> 牛乳</div>
                <div className="flex items-center"><span className="w-20 text-slate-400 font-bold text-xs">吸収速度</span> <span className="text-blue-600 font-bold">非常に速い</span></div>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 relative overflow-hidden group hover:border-purple-400 transition-colors shadow-sm">
              ...
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-slate-800">カゼイン<br/><span className="text-sm font-normal text-slate-500">Casein Protein</span></h3>
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-6 relative overflow-hidden group hover:border-green-400 transition-colors shadow-sm">
              ...
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-slate-800">ソイ<br/><span className="text-sm font-normal text-slate-500">Soy Protein</span></h3>
        ...
        <section className="mb-16">
           <div className="flex items-center gap-3 mb-8">
            <div className="bg-blue-100 p-2 rounded-lg"><Clock className="w-6 h-6 text-blue-600" /></div>
            <h2 className="text-2xl font-bold text-slate-800">2. 効果を最大化するタイミング</h2>
          </div>
            ...
            <div className="flex flex-col md:flex-row bg-white border border-slate-200 rounded-xl p-6 items-center shadow-sm">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-bold text-slate-800 mb-2 flex items-center">
                  運動後 30分以内 <span className="ml-3 text-xs bg-blue-600 text-white px-2 py-0.5 rounded font-bold">ゴールデンタイム</span>
                </h3>
        ...
        <section className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
           <div className="flex items-center gap-3 mb-6">
            <div className="bg-blue-100 p-2 rounded-lg"><AlertCircle className="w-6 h-6 text-blue-600" /></div>
            <h2 className="text-2xl font-bold text-slate-800">よくある疑問</h2>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h4 className="font-bold text-slate-800 mb-2 flex items-center"><CheckCircle2 className="w-4 h-4 text-blue-600 mr-2"/>太りませんか？</h4>
              <p className="text-sm text-slate-600 leading-relaxed">
                プロテイン自体は低脂質・低糖質なものが多いです。あくまで食事の補助として、1日の総カロリーを超えない範囲で飲めば太ることはありません。逆に代謝アップに繋がります。
              </p>
            </div>
            <div>
              <h4 className="font-bold text-slate-800 mb-2 flex items-center"><CheckCircle2 className="w-4 h-4 text-blue-600 mr-2"/>運動しない日も飲む？</h4>
              <p className="text-sm text-slate-600 leading-relaxed">
